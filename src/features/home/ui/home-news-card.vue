...
<template>
  <div
    class="relative z-[175] flex w-full shrink-0 flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#f7f7f7] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
  >
    <div class="h-[240px] shrink-0 self-stretch overflow-hidden rounded-[10px] bg-[rgba(217,217,217,0.2)]">
      <img
        class="object-cover object-center"
        src="https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-20/C5QW4D44SS.png"
        alt=""
      />
    </div>
    <div
      class="relative z-[177] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
    >
      <div
