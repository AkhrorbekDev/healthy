<template>
  <div class="main-container relative mx-auto my-0 w-full overflow-hidden bg-[#f0f4f1]">
    <app-section>
      <div class="relative z-[47] mt-[80px] flex w-[832px] flex-col flex-nowrap items-start gap-[12px]">
        <span
          class="relative z-[48] h-[64px] shrink-0 basis-auto self-stretch whitespace-nowrap text-left font-['Onest'] text-[50px] font-semibold leading-[63.75px] text-[#323232]"
        >
          Полезные материалы
        </span>
        <div
    ...
    <app-section>
      <div class="relative z-[155] mt-[60px] flex h-[59px] items-center justify-between">
        <div
        ...
        >
          ...
          <div
            class="relative z-[154] h-[22px] w-[22px] shrink-0 overflow-hidden bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/hh1rryaF1V.png)] bg-cover bg-no-repeat"
          ></div>
        </div>
        <div
    ...
    <app-section>
      <div class="relative z-[51] mt-[30px] flex flex-wrap items-start gap-[19px]">
        <div
          class="relative z-[52] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[53] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/evW6cFwu80.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[54] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
        ...
        <div
          class="relative z-[79] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[80] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/nMAohg2HtK.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[81] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
        ...
        <div
          class="relative z-[106] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[107] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/eS51Gss4SD.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[108] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
        ...
        <div
          class="relative z-[61] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[62] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/vGmiwNNb9q.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[63] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
        ...
        <div
          class="relative z-[88] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[89] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/kCRukDgr9x.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[90] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
        ...
        <div
          class="relative z-[115] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[116] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/YdQcyRwEXQ.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[117] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
        ...
        <div
          class="relative z-[70] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[71] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/n3YhwCYAB7.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[72] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
        ...
        <div
          class="relative z-[97] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[98] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/8QUL2Oncnu.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[99] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
        ...
        <div
          class="relative z-[124] flex w-[467px] flex-col flex-nowrap items-start gap-[25px] rounded-[20px] bg-[#fff] pb-[20px] pl-[15px] pr-[15px] pt-[15px]"
        >
          <div
            class="relative z-[125] h-[240px] shrink-0 self-stretch rounded-[10px] bg-[rgba(217,217,217,0.2)] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/JvmbcY0Xt1.png)] bg-cover bg-no-repeat"
          ></div>
          <div
            class="relative z-[126] flex shrink-0 flex-col flex-nowrap items-start gap-[20px] self-stretch pb-0 pl-[5px] pr-[5px] pt-0"
          >
            <div
      ...
      <div class="relative z-[133] mb-0 mx-auto mt-[60px] flex w-[459px] flex-nowrap items-center">
        <div
          class="relative z-[134] flex h-[51px] w-[51px] shrink-0 flex-col flex-nowrap items-center justify-center gap-[10px] rounded-[100px] pb-[10px] pl-[10px] pr-[10px] pt-[10px]"
        >
          <div
            class="relative z-[135] h-[24px] w-[24px] shrink-0 overflow-hidden bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/f0pBQLabU5.png)] bg-cover bg-no-repeat"
          ></div>
        </div>
        <div
        ...
        <div
          class="relative z-[150] flex h-[51px] w-[51px] shrink-0 flex-col flex-nowrap items-center justify-center gap-[10px] rounded-[100px] pb-[10px] pl-[10px] pr-[10px] pt-[10px]"
        >
          <div
            class="relative z-[151] h-[24px] w-[24px] shrink-0 overflow-hidden bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-21/p9x6FhEwua.png)] bg-cover bg-no-repeat"
          ></div>
        </div>
      </div>
    </app-section>
